...
ActiveRecord::Schema.define(version: 2020_03_20_170149) do
  ...
  create_table "artworks_tags", force: :cascade do |t|
    t.bigint "artwork_id"
    t.bigint "tag_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["artwork_id"], name: "index_artworks_tags_on_artwork_id"
    t.index ["tag_id"], name: "index_artworks_tags_on_tag_id"
  end
